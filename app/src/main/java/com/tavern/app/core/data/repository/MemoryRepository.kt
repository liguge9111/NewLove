...
class MemoryRepository @Inject constructor(
    ...
    /** 更新某代摘要文本 */
    suspend fun updateSummary(id: Long, text: String) {
        val existing = dao.getLatestSummaryById(id) ?: return
        dao.updateSummary(existing.copy(summary = text.trim()))
    }

    /** 删除某代摘要 */
    suspend fun deleteSummary(id: Long) = dao.deleteSummaryById(id)
